...
interface DeletePrefixModalProps {
  prefix: Prefix | null
  onConfirm: (prefixId: number) => void
}

// daisyui modal เปิด/ปิดด้วย checkbox id="modal-delete"
export default function DeletePrefixModal({ prefix, onConfirm }: DeletePrefixModalProps) {
  if (!prefix) return null

  const handleConfirm = (e: React.MouseEvent) => {
    e.preventDefault()
    onConfirm(prefix.prefix_id)
