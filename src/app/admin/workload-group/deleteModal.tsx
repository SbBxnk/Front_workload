...
export default function DeleteModal({
  ...
  return (
    <div className="relative z-[100]">
      ...
      />
      <div className="modal" role={`modal-delete${workload_group_id}`}>
        <div className="modal-box rounded-md dark:bg-zinc-800 p-0">
          <form
            onSubmit={(e) => {
              e.preventDefault()
              handleDelete(e, workload_group_id, workload_group_name)
            }}
          >
            ...
            <div className="flex justify-end gap-4 border-t border-gray-200 p-4">
              ...
              <button
                onClick={(e) => handleDelete(e, workload_group_id, workload_group_name)}
