...
export default function DeleteModal({
  ...
  return (
    <div className="relative z-[100]">
      <input type="checkbox" id={`modal-delete${ex_position_id}`} className="modal-toggle" />
      <div className="modal" role={`modal-delete${ex_position_id}`}>
        <div className="modal-box rounded-md dark:bg-zinc-800">
          ...
          >
            ...
            <div className="flex justify-end gap-4">
              <button
                onClick={(e) => handleDelete(e, ex_position_id, ex_position_name)}
        ...
        <label className="modal-backdrop" htmlFor={`modal-delete${ex_position_id}`}>
          Close
        </label>
      </div>
    </div>
