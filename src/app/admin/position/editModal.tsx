...
export default function EditModal({
    ...
    return (
        <div className="relative z-[100]">
            <input type="checkbox" id={`modal-edit${position_id}`} className="modal-toggle" />
            <div className="modal" role={`modal-edit${position_id}`}>
                <div className="modal-box rounded-md dark:bg-zinc-800">
                    <form onSubmit={(e) => { e.preventDefault(); handleEdit(e, position_id, editedPosition) }}>
                        ...
                        <div className="flex justify-end gap-4">
                            ...
                            <label
                                htmlFor={`modal-edit${position_id}`}
                ...
                <label className="modal-backdrop" htmlFor={`modal-edit${position_id}`}>
                    Close
                </label>
            </div>
        </div>
