...
export default function DeleteModal({
  ...
  return (
    <div className="relative z-[100]">
      <input type="checkbox" id={`modal-delete${position_id}`} className="modal-toggle" />
      <div className="modal" role={`modal-delete${position_id}`}>
        <div className="modal-box rounded-md dark:bg-zinc-800">
          ...
          >
            ...
            <div className="flex justify-end gap-4">
              ...
              <label
                htmlFor={`modal-delete${position_id}`}
        ...
        <label className="modal-backdrop" htmlFor={`modal-delete${position_id}`}>
          Close
        </label>
      </div>
    </div>
