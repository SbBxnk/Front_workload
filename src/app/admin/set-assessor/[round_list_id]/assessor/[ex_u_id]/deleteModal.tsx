...
export default function DeleteModal({
  ...
  return (
    <div className="relative z-[100]">
      <input
        type="checkbox"
        id={`modal-delete${set_asses_info_id}`}
          ...
          >
            ...
            <div className="flex justify-end gap-4 border-t border-gray-200 p-4">
              ...
              <button
                ...
                className="text-md flex h-10 w-20 items-center justify-center text-nowrap rounded-md bg-red-500 px-4 font-light text-white transition duration-300 ease-in-out hover:bg-red-500/80"
              >
                ยืนยัน
              </button>
            </div>
