...
export default function DeleteModal({
  ...
  return (
    <div className="relative z-[100]">
      <input type="checkbox" id={`modal-delete${round_list_id}`} className="modal-toggle" />
      <div className="modal" role={`modal-delete${round_list_id}`}>
        <div className="modal-box rounded-md dark:bg-zinc-800">
          <form
            onSubmit={(e) => {
              e.preventDefault()
              handleDelete(e, round_list_id, round_list_name)
            }}
          >
            ...
            <div className="flex justify-end gap-4">
              <button
                onClick={(e) => handleDelete(e, round_list_id, round_list_name)}
              ...
              <label
                htmlFor={`modal-delete${round_list_id}`}
        ...
        <label className="modal-backdrop" htmlFor={`modal-delete${round_list_id}`}>
          Close
        </label>
      </div>
    </div>
