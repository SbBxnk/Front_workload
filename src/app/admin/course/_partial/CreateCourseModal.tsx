...
export default function CreateCourseModal({
  ...
  const handleOnChangeBranch = (branch_id: number) => setBranchId(branch_id)

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    onSubmit({ course_name: courseName, branch_id: branchId })
    setCourseName('')
    setBranchId(0)
  ...
  return (
    <div className="relative z-[100]">
      ...
      <div className="modal" role="dialog">
        <div className="no-scrollbar modal-box rounded-md p-0 dark:bg-zinc-800">
