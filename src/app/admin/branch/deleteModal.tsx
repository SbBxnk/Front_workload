  ...
  return (
    <div className="relative z-[100]">
      ...
      <div className="modal" role={`modal-delete${branch_id}`}>
        <div className="modal-box rounded-md dark:bg-zinc-800">
          ...
          >
            <div className="flex items-center">
              <GraduationCap className="mr-2 h-7 w-7 text-business1 dark:text-blue-500/80" />
            ...
            <div className="flex justify-end gap-4">
              ...
              <label
                htmlFor={`modal-delete${branch_id}`}
        ...
        <label className="modal-backdrop" htmlFor={`modal-delete${branch_id}`}>
          Close
        </label>
      </div>
    </div>
