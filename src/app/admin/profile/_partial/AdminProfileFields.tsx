              ...
              <div className="flex flex-col gap-4 md:flex-row">
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    type="number"
                    disabled={!isEditing}
                    className={`w-full rounded-md border-2 ${isEditing ? 'border-amber-500' : 'border-gray-300'} px-4 py-2 text-sm font-light text-gray-600 transition-colors duration-300 ease-in-out focus:border-blue-500 focus:outline-none disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-50 dark:border-zinc-600 dark:bg-zinc-800 dark:text-gray-400 dark:disabled:bg-zinc-700`}
