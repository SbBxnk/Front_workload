...
interface CreateModalProps {
  ...
  formData: FormDataSubTask
  handleInputChange: (e: React.ChangeEvent<HTMLInputElement>) => void
  setFormData: React.Dispatch<React.SetStateAction<{ subtask_name: string; task_id: number }>>
  mainTasks: MainTask[]
}
...
export default function CreateModal({
  ...
  const handleOnChangeMainTask = (task_id: number, task_name: string) => {
    setFormData((prevData: FormDataSubTask) => ({
      ...prevData,
      task_id: task_id,
    }))
  }
        ...
        <div className="relative z-[100]">
          ...
          <div className="modal" role={`modal-create`}>
            <div className="modal-box rounded-md dark:bg-zinc-800 p-0">
              <form onSubmit={(e) => handleSubmit(e, formData.subtask_name, formData.task_id)}>
