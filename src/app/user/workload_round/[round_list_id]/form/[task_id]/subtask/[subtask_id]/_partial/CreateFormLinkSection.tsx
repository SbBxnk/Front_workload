...
import type { CreateFormLinkData } from './createFormModalTypes'

interface CreateFormLinkSectionProps {
  links: CreateFormLinkData[]
...
export default function CreateFormLinkSection({
  links,
  handleRemoveLink,
  handleLinkChange,
  handleAddLink,
}: CreateFormLinkSectionProps) {
  return (
