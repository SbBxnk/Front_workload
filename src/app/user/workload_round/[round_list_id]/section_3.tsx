            ...
            <div className="w-full overflow-x-auto">
                <table className="min-w-[640px] w-full border-collapse border border-gray-300 dark:border-gray-700">
                    <thead className="bg-gray-50 dark:bg-gray-800">
                        <tr>
                            <th className="w-3/5 border border-gray-300 dark:border-gray-700 px-3 py-2 text-center text-sm font-normal text-gray-700 dark:text-gray-300">
                                องค์ประกอบการประเมิน
                            </th>
                            <th className="w-40 border border-gray-300 dark:border-gray-700 px-2 py-2 text-center text-sm font-normal text-gray-700 dark:text-gray-300">
                                คะแนนเต็ม
                            </th>
                            <th className={`border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-normal text-gray-700 dark:text-gray-300 ${isFinalized ? 'w-32' : 'w-32'}`}>
                                คะแนนที่ได้
                            </th>
                            {isFinalized && (
                                <th className="w-32 border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-normal text-gray-700 dark:text-gray-300">
                                    คะแนนที่ได้ (ประเมิน)
                                </th>
                            )}
                            <th className="w-32 border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-normal text-gray-700 dark:text-gray-300">
                    ...
                    <tbody className="bg-white dark:bg-zinc-900">
                        <tr>
                            ...
                            <td className="border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-light text-gray-800 dark:text-gray-200">
                                {formatScore(performanceScoreOutOf70)}
                            </td>
                            {isFinalized && (
                                <td className="border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-semibold text-green-600 dark:text-green-400">
                        ...
                        <tr>
                            <td className="border border-gray-300 dark:border-gray-700 px-3 py-2 text-end text-sm font-normal text-gray-800 dark:text-gray-200">
                                รวม (7) + (8)
                            </td>
                            <td className="border border-gray-300 dark:border-gray-700 px-2 py-2 text-center text-sm font-light text-gray-800 dark:text-gray-200">
                                {formatScore(totalMaxScore)}
                            </td>
                            <td className="border border-gray-300 dark:border-gray-700 px-1 py-2 text-center text-sm font-semibold text-blue-600 dark:text-gray-100">
